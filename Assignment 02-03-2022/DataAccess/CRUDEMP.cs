...
{
    internal class CRUDEMP : IDataAccess<ComEmployee, int>
    {
        SqlConnection Conn;
        SqlCommand Cmd;
        ...
        async Task<ComEmployee> IDataAccess<ComEmployee, int>.DeleteAsync(int id)
        {
         ...
         async Task<ComEmployee> IDataAccess<ComEmployee, int>.UpdateAsync(int id, ComEmployee entity)
        {
       ...
       async Task<ComEmployee> IDataAccess<ComEmployee, int>.GetDataAsync(int id)
        {
            ComEmployee employee = new ComEmployee();
            try
            {
       ...
       async Task<IEnumerable<ComEmployee>> IDataAccess<ComEmployee, int>.GetDataAsync()
        {
