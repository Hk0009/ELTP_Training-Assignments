...
using Assignment_16_03_2022_final.Services;
using Microsoft.EntityFrameworkCore;
using static Assignment_16_03_2022_final.Services.IService;

namespace Assignment_16_03_2022_final
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IService<Mydatabase, int>, DepartmentServices>();
            services.AddScoped<IService<ComEmployee, int>, EmployeeServices>();
           // services.AddScoped<IService<User, int>, UserServices>();
